...
import { report, project } from 'src/interfaces/interfaces';
...
export const Project = ({ data }: React.PropsWithChildren<projectProps>) => {
    ...
    const handleClick = async (url: string) => {
        ...
        history.push(`/result/LD/${data.cleanURL}/0111111111`);
    }
    ...
    return (
        <Row gutter={[20, 20]} key={uuidv4()} >
            <Col span="16" offset={4} className="flex margin-xs boder-round shadow-xs project">
                <Image
                    src={`./depclean-web/images/${data.img}`}
                    ...
                    <div className="flex description">
                        ...
                        <div className="flex flex-vertical center">
                            <Button
                                ...
                                type="primary"
                                size="large"
                                onClick={() => handleClick(`${data.cleanURL}.json`)}
                            >
                                DepClean Project
                            </Button>
