    ...
    return (
        <Row id="search"
            ...
            <Col span={13} className="flex flex-list p-xl flex-justify-center">
                ...
                <p>Bloated dependencies are libraries that the build tool packages with the application’s compiled code but that are actually not necessary to build and run the application. DepClean detects all the unused dependencies declared in the pom.xml file of a project or imported from its parent.
                </p>
                <p>
                    Detailed <a className="link-green" href="https://github.com/castor-software/depclean" target="_blank" rel="noreferrer">instructions</a> regarding how to run DepClean on a project can found in the Github. The JSON file generated by DepClean can be Scanned to visualize. All scanned data will remain in the users computer, we do not copy any information to our servers.
                </p>
